...
WebUI.click(findTestObject('DEMOBLAZE/Phones/Lumia 1520/Page_STORE/a_Nokia lumia 1520'))

WebUI.click(findTestObject('DEMOBLAZE/Phones/Lumia 1520/Page_STORE/a_Add to cart'))
