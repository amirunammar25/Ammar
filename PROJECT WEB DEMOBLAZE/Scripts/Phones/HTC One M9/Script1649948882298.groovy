...
WebUI.click(findTestObject('DEMOBLAZE/Phones/HTC One M9/Page_STORE/a_HTC One M9'))

WebUI.click(findTestObject('DEMOBLAZE/Phones/HTC One M9/Page_STORE/a_Add to cart'))
