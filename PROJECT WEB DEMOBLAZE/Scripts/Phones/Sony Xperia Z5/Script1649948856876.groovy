...
WebUI.click(findTestObject('DEMOBLAZE/Phones/Sony Xperia Z5/Page_STORE/a_Sony xperia z5'))

WebUI.click(findTestObject('DEMOBLAZE/Phones/Sony Xperia Z5/Page_STORE/a_Add to cart'))
