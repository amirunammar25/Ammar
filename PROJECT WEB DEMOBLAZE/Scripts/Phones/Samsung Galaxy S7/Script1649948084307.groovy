...
WebUI.click(findTestObject('DEMOBLAZE/Phones/IPhone 6 32GB/Page_STORE/a_Iphone 6 32gb'))

WebUI.click(findTestObject('DEMOBLAZE/Phones/IPhone 6 32GB/Page_STORE/a_Add to cart'))
